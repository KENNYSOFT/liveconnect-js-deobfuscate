var a0a = ['keydown', 'videoHeight', 'BNbxf', 'd1469f24-5e03-40db-9289-7be2c0423b1d', 'pODrE', 'seek_to', 'querySelectorAll', 'playBtn', 'changeCurrentLevel', 'hGmeK', 'inBSc', 'fd094607-5731-466b-8631-37e08d8cbcff', 'attachVideoListeners', 'volumeBtn', 'rich360', 'btnTxt', 'innerHTML', 'GET', 'hkXQi', 'vrnfG', 'jdpQe', '***', 'webkitFullscreenEnabled', 'playerBottomWrap', '201109_teacher', 'mozCancelFullScreen', '#noticeChatWrap p[name=desc]', 'OYYKV', '</span>', 'interactStartOffset', '_isDummy', 'is_mute', '#holdChatScrollLabel', '.c-button', '#c-menu--', '4f2bcf78-c4ad-4d6d-89b3-551d83525fff', 'attr', 'background-position-x', 'GsZkU', 'DedVD', 'chat_full', '_ready_state', 'fFrUr', 'ZZRoX', 'qmGcm', 'input', 'wakeupController', 'ltstr', 'remove', '_initHideCtroller', 'withCredentials', 'MEDIA_ATTACHED', 'YbCva', 'eeZnG', 'FRAG_LOOP_LOADING_ERROR', 'pDkUM', 'd7a8f442-e734-4069-92c2-49e9c528297e', 'constructor', 'orientation', '{}.constructor("return this")( )', 'expires=', 'tDhHr', 'initChatUIEvent', 'parent', 'INZSa', 'innerText', 'd8f2dfa4-8e0f-4b40-9ae6-92a7b3d15af5', 'startLoad', 'destroy', 'scrollTop', '186accfb-f3f4-441d-adee-0d78e34e9d18', '権限がありません', 'showDefaultSubtitle', 'ZXZQo', 'path', 'SdZOE', 'jMVRQ', 'fromCharCode', 'onerror', 'pWSct', ' on', '#pageWrap', 'TxXqI', 'chatContents', 'not', 'TwPpb', 'RICH360_STATE_CHANGE', '_subtitleList', 'Auth code', 'MKiuD', 'liveSyncDurationCount', '_subtitleManager', 'contains', 'aeQmx', 'ielUZ', 'EVENT::resize', 'orientationchange', 'JVNJF', 'firstFrag', '210110_gentleman', 'locked', 'P_ALERT_END_LIVE_DESC', 'msFullscreenEnabled', '201121_xia', 'initLoadingState', '#artistChatWrap', 'assign', '201011_cix', 'currentLevel', 'wheel', 'poster', 'PmVUn', 'href', 'preventDefault', '.user_msg', 'psstr', '_canvasTimeStampIndex', '201122_xia', 'TYAJi', 'yonghee.png', 'nIhqS', 'landscape-primary', 'yakMc', '_isMultiview', '1.25em', 'adylV', 'RQohq', 'kyIhn', 'navigator', 'span[name=text]', 'VtyXW', 'CHtaD', '#wmark', 'landscape', 'cd6f57e3-d512-4692-82e9-7aee2571a48a', 'tExfy', 'chatInputWrap', 'is-active', '.webvtt', 'TDhIC', 'RICH360_SOURCE_CHANGE', 'src', ';path=/', 'url(', 'Request timeout', 'click', 'UpNbN', 'HgjoV', 'fail', 'splice', 'maxTouchPoints', '201121_ohmygirl_p', ' video : ', 'cusDD_opt', '_value', 'drawImage', '#alertPopup p[name=desc]', 'body', '#volumeBtn', 'startPosition', '[TEST]vod_test', 'liveMaxLatencyDurationCount', 'Keksr', '-16px', 'getDate', 'VLxgm', 'ccSelectBtn', 'trident', 'margin-bottom', '210116_gentleman_1', 'uIpoV', 'mac', 'qrtWv', 'touchend', 'mJakr', 'volumeSlider', 'チャットを使用できません', 'img', '.m3u8', 'substring', 'ZVcwx', 'Ifqfd', 'deltaY', 'createSubtitleBtn', 'rPeWm', '_initQualityUI', '_loadedValue', 'fVbwB', 'mBXUe', '_videoSubPositions', 'format', 'relative', 'RICH360_ERROR', 'checked', 'fullscreenChanged', 'iqDbv', 'requestAnimationFrame', 'ZUDQC', 'XHprA', '_user_id', 'umWgn', 'disabled', 'oFMXt', 'AUTO', 'MSMfQ', 'initEventListener', 'white', 'HsglK', '#playThumbnail button', 'c1ae68f0-a65e-44ea-8793-9cc24c8442bd', '_logData', 'channel', 'placeholder', 'length', 'JwrUL', 'button', 'お知らせ', 'AIjbQ', 'VzMpK', '.cusDD_opt', 'RICH360_ENDED', 'quality_change', 'f5e6cfd4-ba43-4c9a-9dba-e0973496f2b2', 'timeout', '#playerWrap', 'attachHlsListeners', 'platform', 'XykuH', 'beRWa', 'UYmqx', 'ztJrB', 'mode', 'wrapAll', 'KaEBo', 'qualityPopup', '#sliderPaddingDiv', '201205_theboyz', 'fullscreenEnabled', 'MEDIA_ERROR', 'XuQDb', 'pnzqr', 'wuHbF', 'XdWiF', 'cetPw', 'vendor', 'c-menu--slide-right', 'qualityList', 'zrxKB', 'zZDlP', 'ojwGl', 'P_ALERT_LIMIT_DEVNUM_DESC', 'qjjQG', 'cusDD_default', 'rHmGr', 'textAlign', 'PoKPw', 'px)', 'worzt', 'name', 'zaoMJ', 'EOzmc', 'szkXC', 'setSubtitleItv', '210327_sinbiapt', '.pl-btm-wrap', 'lock', 'encrypt', 'qualityPopupItems', '4861a19c-18c1-469e-aa3c-3bf913ed901f', 'pl-t-fullscreen', 'vtpQw', 'view', 'HKpbI', 'lastIndexOf', 'P_ALERT_TITLE', 'sub_positions', 'bgnms', '_ticket_id', '6fce5920-eb64-49df-9a8d-d67c25632f36', 'sLign', 'LlUZv', 'width', 'SMSCo', 'edg', '1f176c81-c0e5-463a-ae70-5938a250e396', '22575e2c-83e0-4d40-a4d7-731eabb41bee', 'endsWith', 'WPnzr', 'P_ALERT_OK', 'sendLog', 'drawSubtitles', 'enstr', '5dc04bcd-bcdd-4add-b7bb-26995c7a166e', 'category', 'chat-i-pushy', 'stopPropagation', 'ceil', 'onload', 'FGKpY', 'replace', 'yZOgy', '68de58a5-38e5-41d4-a33b-41e70d554138', 'dbstr', 'prev10sBtn', '.c-menu__close', '_subtitleDiv', 'dispatchEvent', 'wYWUt', 'user_id', 'container', '210415_parkseojin', 'IOnCO', 'hcIqW', 'innerHeight', 'SHchy', 'Please try again later', 'Apple', 'ZwCzy', 'textShadow', '_video', 'pXdso', 'ch_artist', 'Menu', 'WRipZ', 'subtitleTrack', 'KHWMh', 'getRandomInt', 'baseCode', 'thumb', '<p style="color:white;word-break:break-all;font-weight:700;text-shadow:#000000 0px 0px 7px;padding:1px 5px;width:', '#c-mask', '13748634-68a6-4a78-b05c-e5cf3272eb5e', 'setChatHistory', 'desc', 'cCNWM', 'Code authentication', 'MacIntel', 'TgwTO', 'RykMd', 'newaQ', 'use_vod', 'dev_demo_event_02', 'play_status', 'durationStart', 'webkitfullscreenchange', '#playerBottomWrap', 'initMultiviewManifest', 'replaceVideo', '201226_pentagon_vod', 'UUbhz', 'yyyy', '.cusDD_arrow', 'hasOwnProperty', 'mozFullScreenEnabled', 'riocX', '_parent_dom', '_config', '</p>', 'content_data', '>의 라이브가 진행중입니다.', '201102_littlebasketball', 'KINESIS_CHAT', 'コード認証', 'cdQfW', 'position', 'HmYFl', '200905_2pm', 'multiview_list', 'getBoundingClientRect', 'enableMenuOpeners', '--vh', 'Swbtf', '210320_hwangyunseong_1', 'button[name=artistchatnavbtn]', '_subtitleArr', 'fullscreen not enabled', 'daLiy', 'portrait-primary', 'exitFullscreen', '210313_boyhood', 'reload', 'next10sBtn', 'TkFik', '#ticketDiv', '@@oldVideo.currentTime : ', 'putRecord', 'videoWidth', 'chatWrap', 'clearLogData', 'WQEWb', 'startPTS', 'pAnco', 'tagName', ' undraggable unselectable', '200924_thepromiseoftheday', 'EVENT::#chatInput::focus', 'MTGwE', 'req_data', 'baejinyoung.png', 'ZBuKh', 'NwptI', 'klsfm', 'MANIFEST_PARSED', 'EDrZI', 'px;margin-left:', 'ZxWdv', 'getUTCMilliseconds', 'maskId', 'OFF', '200819_leeyongshin', 'replaceWith', 'Ndjji', 'getNickName', 'inputEvent', 'setChatChannels', 'timeupdate', 'XRacZ', 'focus', '2e282fdc-a1ee-49b8-8ee0-a4178a74eb82', 'warn', 'addCueData', 'JOJCu', 'RICH360_DURATION_CHANGE', 'reduce', 'navBtnWrap', 'Cxuad', 'children', ' cusDD', 'disableChatInput', 'pub-c-bf51339c-bf9b-4e3e-8f44-dadc40e90d23', 'DkKiT', 'fc_default cusDD_opt', 'progress', 'initialize', 'c291b33a-291c-4935-b7e9-01c72b74b2d8', '/user_auth/session_check/', 'background-position-y', 'recvCtrlChMsg', 'RICH360_PLAY_PAUSE_CHANGE', 'qualityItems', '[warning]', '210417_cix', '_play_status', 'ILNKn', '_wakeupPastTime', 'wUxOy', 'DBXvg', 'QeCju', '71aad509-9790-4cde-8a9c-9092fc734845', 'vfQHR', 'QbSWU', '|#|', '_device_id', 'classList', '30e05e26-728d-4afd-838e-2e7fc18bc805', 'Live chat is currently unavailable.', 'channels', '.pl-i-live', 'NiieC', 'z-index', 'textTracks', 'sliderPaddingDiv', 'mvMainDiv', 'crossOrigin', 'PZYaY', '_initSubtitleUI', 'scrollHeight', 'pl-i-full float_r', 'string', 'bottom', 'startSN', 'has-active-menu', '.scrollbar-inner', '200927_woodz', 'addEventListener', 'setContentData', '[JSH]VOD', '_sourceBase', 'connected to channels: ', 'yiwmg', 'RICH360_BUFFER', 'setIsFullScreen', 'IDLE', 'LjVIH', 'tracks', 'vLHGR', 'lJNDu', '#qualityPopup', 'DigxE', 'RICH360_LIVE_ENDED', 'f30bdaaa-a3fe-4151-8e15-4fb9802c26fa', 'RICH360_ACCESS_DENIED', 'details', 'touchstart', 'aKpVN', 'pCzrr', 'NpTTd', 'nNOpG', 'filteringChatText', 'X-CSRFToken', 'play_on', '.cusDD', 'alertPopup', 'Sqjya', 'yyyyMMdd-HH:mm:ss:', 'cjNMh', 'view_wrap', '_loggerItv', 'language', 'current_channel_id', 'FPbTq', 'duration', 'LGUhW', 'originalEvent', 'type', 'history', 'nextAutoLevel', 'RICH360_READY', 'parentElement', 'CriOS', 'seekEvent', 'ogUUe', 'resizeToCanvasImage', '인증코드', 'loadChatFilterData', 'dyAAs', '채팅을 사용할 수 없습니다.', 'dgOVp', 'EgCxF', 'bfTime', '#multiViewWrap', '#o-wrapper', 'xCqjF', 'seeking', 'verticalAlign', '210327_hyukoh', 'LqhFZ', '.cusDD_options', 'KXHsG', 'DKWHf', 'open', 'listeners', 'qbUgK', 'BmxKB', 'kJGOC', 'FFPbp', 'pqPdM', 'qizGM', 'FQQvD', 'LAFNT', 'KSyhI', 'fullscreenElement', 'ShOPw', 'className', '/static/filtering/chat_filtering.txt', 'now', 'NJyfA', 'OsImS', 'toDataURL', '201108_victon', 'validate_response', 'generate16byte', 'webkitFullscreenElement', 'attributes', 'siblings', '@@newVideo.currentTime : ', 'bhomB', 'XJEyX', 'Data', '[JSH]LIVE_MULTI', 'changeSource', 'quality', '認証コード', 'seekBar', 'qmUEL', 'hEqQq', 'style', 'config', 'overrideMimeType', 'height', '_multiviewCtx', 'EWEXX', '#chatSendBtn', 'css', 'source', 'getMilliseconds', 'status', 'content_id', 'ready', '_logMaxLength', 'webkitRequestFullscreen', 'f30aa9c1-9342-4113-8134-5a75a8464651', 'pwQKz', 'pdjoI', 'oQWBP', 'recoverMediaError', 'data', 'csrftoken', '(?:^|\s+)', '_render_once_on_seek', 'pl-i-play', 'message', 'release', 'initHideCtrllerEvent', 'TItAH', 'GNIxj', ' containerRatio : ', 'trigger', 'ycymu', '/thumbnails.jpg', 'edge', 'ErrorTypes', '#artistChatList', 'hFYRC', 'fontSize', 'opera', 'cEELW', 'curTime / this.duration : ', 'font-size', 'checkArtistUser', 'vTZAK', 'EYvpi', 'inline-block', 'AxZhp', 'pl-t-fullscreen_nochat', 'initPubnubEvent', 'removeChild', 'timetoken', '#000000 0px 0px 7px', '잠시 후 다시 시도해주세요.', 'getHours', 'hideChatWrap', '_thumbnailGridData', 'FRAG_PARSED', 'Permission Denied', 'EVENT::#chatInput::blur', '#multiViewList .view_wrap', 'EYVcB', '21e7d09f-ca8e-4585-9529-e221e5e7f3c6', '_bfVideoWidth', 'ch_chat1', 'toggleClass', 'sub', 'RICH360_AUTH', 'html', 'MqGpS', 'ZcotF', 'nbIjU', 'getMinutes', 'CTSex', 'CUES_PARSED', 'stop', '#artistChatList .user_chat', 'clientX', 'console', 'videoRatio <= containerRatio', 'DKHAD', '% + ', 'p[name=text]', 'AuCXD', '201031_sinbiapt', 'selected', 'hasClass', 'CoIcw', 'NeHey', 'info', 'getVideoSubtitleTrack', 'hVzGA', 'QFsOg', 'ontimeout', '__proto__', 'div:eq(0)', 'PEsBM', 'QZaCQ', 'Zhzgz', 'wait_on', '210116_killerparty', 'isArray', 'getElementsByTagName', 'touchmove', 'webkitExitFullscreen', 'XOepb', 'offsetX', 'slideUp', 'convertChatMsg', 'fullscreen not supported', 'zrrXh', '_req_str', 'GIeAi', '210313_izone', 'nZwcr', 'VFrpX', 'しばらくしてから再度お試しください', 'mZtrR', '#mvMainDiv', 'lang', 'parse', '@@timeDiff : ', '210320_hwangyunseong_2', 'option', 'keldR', 'KlKdf', 'dcb519d5-e770-4377-960d-edc6cf169c68', '3f6d28f4-0c1d-4c31-97bf-55b2a14a113e', 'checkOperationntUser', 'dyGfM', 'uXtxj', 'showMultiPreview', 'VuMWx', 'pause', 'GNfDO', '201108_gidle', 'sHLTK', ' ap&nbsp;hh:mm:ss', 'vMGSd', 'mRhKp', 'pl-t-default_nochat', 'OrSzh', 'KFnYX', 'fabb3e81-e293-4088-91a1-68efca8193ef', 'MXWJK', '#alertPopup p[name=title]', 'base', '_loading_on', 'f3a82d31-a083-4679-88e1-c0961a925afb', 'SsJmg', 'readonly', 'QLjsi', 'barDiv', 'isSupported', 'initChatInterval', '%, transparent ', 'WtKZd', 'YKZcg', 'is_main_channel', 'IZYFd', 'value', 'NAME', 'push', '210314_izone', '201218_woodz_vod', 'text', '_display', '.ta_c', 'toUTCString', '#chatContentWrap .scroll-bar', 'singleview_list', 'display', 'P_CHAT_ABLE_DELAY_PLACEHOLDER_%(delay)s', 'mute', 'VHVrW', 'seunghun.png', 'oBzXf', 'messages', 'offsetWidth', 'eFvRh', 'landscape-secondary', '717d72f3-a23b-4824-aacc-8cdb17cdb4b7', 'POST', 'unbind', 'search', 'ovPYz', 'top', 'Missing Hls.', 'SOWqx', '270638ff-f1e5-4717-bf80-52bed1a491e6', 'riTed', 'loadingWrap', 'span[name=time]', 'calc(', '#chatInputWrap', 'menuOpeners', 'device_id', 'sQBKL', '210227_mona', '201121_joyangel', '_ui_play', 'label', 'mozfullscreenchange', '_multiviewDivArr', '#chatList .user_chat:eq(-1)', 'showChatWrap', 'FxiOS', 'isNan', 'LfIar', '#volumeSlider', 'wYcsS', 'TJIJO', 'stringify', 'metadata', 'return (function() ', 'paddingBar', 'c67e2edc-3a6f-4091-9b4b-28fde50495a8', 'location', 'AQUqc', 'etCkn', 'KoSJj', 'append', 'block', 'IfFnl', 'RICH360_SEEK', 'artist_chat_dummy', '[ticket_exposure]', 'color', '_bfVideoHeight', 'zDAOs', '#popupTitle, #popupDesc', 'pl-i-screen float_r', 'android', 'isChatUsed', 'setTime', 'trace', 'drawCanvas', 'KqTYd', 'Tkkda', 'api_server', 'slice', '1c4b0fed-bc2b-4101-8771-19cc94dca0fd', 'DXTkq', 'video', 'authorize', 'AFfUu', 'tUAAS', '36853e07-ebac-4576-a6a8-15eca6822945', 'caFvh', 'multiViewList', 'Events', 'size', 'xSpJk', 'Ssmab', 'mTwNW', 'nXXOt', 'cvfcn', 'getSeconds', 'gTbWB', 'ysqSG', 'timeDictionary', 'setPubnubAPI', '#alertPopup button[name=okbtn]', 'jtxQh', '_view', 'webkitbeginfullscreen', 'hls_url', 'LlLio', '4b5d825b-4c0d-4cbd-898a-46a5adfcb7e4', '51905d9b-3b05-4667-b9e1-4fa5391d06fb', 'EVENT::orientationchange', 'visible', 'change', 'soGZd', 'gLjaK', '201101_sinbiapt', '|*|', 'canplay', 'YWLxy', '/static/imgs/c_event/', 'createQualityDiv', 'setDurationText', 'CXOoP', 'zmqcZ', 'createUserChatDiv', 'startFragPrefetch', 'anonymous', 'MSFullscreenChange', 'loadedmetadata', 'aOrsj', 'gYhtZ', 'izZwB', '_updateCanvasFlag', 'pageWrap', 'this is not a media error, try to recover', '/thumbnail_info.json', 'join', 'UxMlO', 'frag.startPTS : ', 'removeAttr', 'xcoqN', 'EbFUv', 'TXegn', 'rRSzW', 'lJIMj', 'window', 'liveSyncPosition', 'slick dark', '_player', 'yyyy-MM-dd HH:mm:ss:mss', 'RSDbp', 'UbpJC', 'jnnFl', 'sCuxp', 'msgClass', 'GhvTX', 'zQTMY', 'WGHOF', 'views', 'IVfMh', '201225_yoonjisung', 'player-video-wrap', 'viJqZ', 'Manager', 'hideDefaultSubtitle', 'QbXza', 'aQSaD', 'text/plain; charset=utf-8', 'mozFullScreenElement', 'VIDEO', '_is_fullscreen_button', '/static/filtering/chat_filtering_cix.txt', 'send', '#chatInput', 'toLowerCase', 'Please try again', 'xsvAb', 'ypUXO', 'test', 'loadingDiv', 'hidden', 'table', 'mvCanvas_', 'hwUSr', 'Authorization failed', 'FzWny', 'vIEOL', 'onloadend', 'eab1a962-c951-40a3-8e17-77d3398c0161', 'playThumbnail', 'HSgAA', 'chrome', '8febe59f-1915-4f25-8a27-3e72d52129c8', 't_my', 'hostname', 'contents', '_ui', 'vVPMw', 'WrkWy', ' select : ', '26a2c6a7-de48-42fc-becb-105e7455affd', 'setUserId', 'vfEBo', 'KvGLv', 'undefined', 'compareArray', 'FwdAN', 'canPlayType', 'volume', 'options', 'WmKQS', 'lJZgv', 'playerSliderArea', 'omiiy', 'Synno', '66d65700-0799-4007-9289-ecbd17699128', '_quality_list', '#alertPopup', 'SbaVa', '[TEST]event_test', 'has-', 'webkit-playsinline', 'close', '201226_xia', 'entry', 'track', '_canvasFPS', 'artist_account', 'pl-i-pause', 'lWppq', 'playerWrap', '#chat-i-pushy', 'thumbInteracting', 'events', 'cusDD_slick_d', 'getUserId', 'tkoeh', 'kZBcd', 'right', 'xhrSetup', 'playerSlider', '#noticeChatWrap button[name=closebtn]', 'indexOf', 'ehult', 'zpTWj', 'a9731791-ae47-429f-a599-ca07353bb501', 'backgroundImage', 'tFkBL', 'nodeValue', 'initial_view', 'sub-c-80f91ce6-c710-11ea-8107-5e100a74f828', 'onreadystatechange', 'rqstr', 'uDgVe', '#chatCloseBtn', 'px;margin-bottom:2px;">', 'XOcLO', ' none', 'd6a2863d-9bd6-4b34-ad92-3ca1c8a0eba4', 'detachMedia', 'CeWnG', 'prepend', 'WeHby', '#chatWrap', 'startLevel', '210320_sacconcert', 'gIyac', 'HmOQR', 'P_ALERT_TRY_AGAIN_DESC', 'KnERL', 'forEach', '3e1562d4-7f5a-4e37-b13c-9726eca336bc', 'visibility', 'multiview_count', 'playing', 'NETWORK_ERROR', '(?:\s+|$)', '_dom_element', 'yDJOn', '_initEvents', 'zeyTG', 'px - ', 'dwqiG', '#loadingDiv', '@@@video waiting call : ', 'getTime', 'updateVideoArrangement', 'qGfTZ', 'string length must be 16', 'levels', '/static/filtering/chat_filtering_idle.txt', 'trim', 'rnstr', 'arrangeVideo', 'xtgNk', '_video_source', 'zh_Hans', 'dlvke', '_web_ui', 'QbKRB', '7c90cda7-4037-477b-bc59-15016890756e', 'a462ed03-1979-49a5-95de-13de9cf7a642', 'createSubtitleDiv', '210115_gentleman', 'removeClass', 'prototype', 'appendChild', 'OLmOC', '_options', 'XevzC', 'webkitendfullscreen webkitbeginfullscreen', 'RICH360_QUALITY_CHANGE', 'updateNotice', 'random', 'ZvNbj', 'xxjtQ', 'gRNLq', 'MSStream', 'exception', 'ewfMO', 'TDbgt', 'map', 'CANVAS', 'slick light', 'setResizingPage', 'IfKGM', 'Firefox', 'EAtEF', '#alertPopup button[name=okbtn],#alertPopup button[name=closebtn]', '你没有权限访问', '.pl-ctr-wrap', 'closeBtn', 'qarpx', 'nickname', 'ccSelect', 'uyFLV', 'getNoticeChannel', 'keyCode', '/output', '_manifest', 'HopJO', 'dtJwP', 'dCgDp', 'button[name=chatnavbtn]', 'jnoqG', 'chat_channel_num', 'cookie', 'UlOlw', 'attachMedia', 'KBnXQ', 'playerSliderThumb', '[delete]', 'interactStartX', '#ccSelectBtn', 'toString', 'selectedMultiviewCanvas', '954f0cf8-c2ff-4658-9f81-d37e6cfc94ff', 'changeSingleView', 'SLsBH', 'getAttribute', 'main_position', 'msRequestFullscreen', 'pzTwK', 'transparent', 'ticketDiv', '%, #ea0029 ', 'win16|win32|win64|mac|macintel', 'wrapper', 'user_chat_dummy', 'Video error encountered. Running recover function', 'ZlfgD', 'ec851af1-b551-4076-bab8-60ed51c38e74', 'dataset', '코드 인증', 'msFullscreenElement', 'add', '\s+', '303fff52-27a7-4991-9cc8-4c34ae28417a', 'p[name=nickname]', 'portrait-secondary', 'sliderThumbnail', 'ldcOM', 'end', 'background-image', 'ydKfG', 'pause_on', 'URRzG', 'seek', 'fFZgm', '4fd7d315-9ee5-4e5b-bf03-467e0d8123b2', '_videoMainPosition', 'jOpkW', '_cues', 'innerWidth', 'RICH360_INIT', '_doubleBufferCanvas', 'use_multiview', '\s+$', 'cues', 'DefaultConfig', 'autoplay', 'c5f88688-08ed-4e43-af96-c3caa464a17c', 'wLDeB', 'qEDgF', 'left', 'startTime', 'clientHeight', 'targetTouches', 'kGGWa', 'portrait', '200925_thepromiseoftheday', 'mouseup', 'arrangement : ', 'pOfdW', 'CUrzq', '_subtitleTrack', 'displayMessageItv', 'qlCrz', 'NnDfk', 'play', '_web_player', 'application/vnd.apple.mpegurl', 'bHEse', 'videoRatio > containerRatio', 'subtitlePopup', 'nodeName', 'web_title', 'stack', 'eHvWs', 'dMjkf', 'omZHp', 'oBmxG', 'hiXEd', '.ts', 'userAgent', 'readyForChange', '_chat_id', '#chatContentWrap', 'HLkTM', 'scstr', '210328_sinbiapt', 'operation_account', 'AOALi', 'FGRuZ', 'getContext', 'ac820489-d611-40e6-ba4f-539b4f83a0bf', 'vxqar', 'BfPhS', 'currentPosition', 'initPlayerUI', 'xJkbN', 'auto', 'measureText', 'showMultiviewBtn', 'pSUsS', 'zeZJu', 'log', 'KcFFE', '<span class="chat_time fc_fff fs_12" style="vertical-align: baseline;">', 'kDwAv', 'playsinline', 'initSubtitle', '#subtitlePopup', 'menu', 'Nrdfg', '#chatList .user_chat', 'fvDlI', '200817_guckkasten', '권한이 없습니다.', '210418_marychou', 'document', 'requestFullscreen', 'EpoKi', 'nickName', 'getLog', 'showChatOpenBtn', 'button[name=multiviewnavbtn]', 'resize', 'substr', '_newVideo', 'addLog', 'onclick', '[TEST]MULVW-3CAM', 'bind', 'createQualityBtn', 'level', 'okCallback', 'RICH360_WAIT', 'querySelector', '[STATUS: ', 'ndcTP', 'd4141fc6-5b17-4034-819e-ba2f6fd631e0', 'SIZE', 'linear-gradient(to right, #fff 0%, #fff ', 'ZdpMc', 'jKAep', 'DYpCc', 'DONE', '_subItv', 'aIYqv', 'xmZ2EWmIIKs85VR8kaDZHnEfKwYMiMeHUSRM2UdK', 'scroll', 'HmukS', 'ADGEE', 'oiVuh', 'isAutoQuality', 'loadSource', 'createElement', 'endTime', 'addListener', '/thumbnails.jpg?', 'oMcLc', 'offsetHeight', '_init', 'msExitFullscreen', 'admin_account', 'PewSw', 'keyboard-show-by-chat-input', 'each', 'ROMAs', 'load', 'KMPww', 'readyState', 'LEVEL_SWITCHED', '_isFullScreen', 'cusDD_options', 'GGUdC', 'thumbDiv', 'getElementById', 'content', 'XHwTn', 'clientWidth', 'HyDNB', 'setHoldChatScroll', 'submitUpdate', 'fullscreenchange', 'MkClU', 'qualitySelect', 'JFXee', 'enableChatInput', 'webkitEnterFullscreen', 'macos', 'valueOf', '_mainDiv', 'Kinesis', 'div', 'mousedown', 'view-name bolder fs_14 fc_point', '210321_leesieun', 'canplaythrough', 'floor', 'target', '_isHideDefaultSubtitles', 'gbmjJ', 'absolute', 'ZjAkK', 'yhfAz', 'CgTxl', '201211_teacher_vod', '210410_sungdameb', 'text-btn fc_default bold', 'IgBAv', 'pnvrN', 'mEiym', '30ced1cf-60b7-4736-88b1-2ed024f5a51c', 'RICH360_SUBTITLE_FOUND', 'PvxOn', 'BKIYo', 'slider', 'WCefr', 'wait', 'xFLfO', 'NON_NATIVE_TEXT_TRACKS_FOUND', '@@@ waitTime : ', 'WUpTY', 'title', '210109_gentleman_1', 'apply', 'heGZR', 'oAAvs', 'initSeekBarThumbnailData', 'startInterval', '.kmv', 'AFzbi', 'Notification', 'VejhD', 'CQzJQ', 'kQpDD', 'NlObB', 'subtitlePopupItems', '_multiviewCanvas', 'showing', 'RsyVd', 'pvhdP', 'use strict', 'addClass', '1eb2193c-733f-49fc-b1f2-385219759eda', 'htdat', '3e158308-4a46-4115-8411-38160c223a00', 'iYQQM', 'addRich360', 'split', 'AvORX', 'displayMessage', '%, transparent 100%)', 'fZWMa', 'ZbSgj', '_hls', 'bold', '#qualitySelectBtn', 'ended', '_customer_id', 'P_ALERT_INVALID_NICKNAME_DESC', 'none', 'abs', 'https://api.liveconnect.co.kr', 'subscribe', 'error', 'vSwJb', 'interpark', 'VkRbF', '210108_gentleman', 'update', 'XMiso', 'mouseout', 'sans-serif', 'pkvUh', '7dff265c-25a8-4dc4-baa6-e354056bd997', 'grid_y', 'RpNeG', 'playStatus', 'P_CHAT_INPUT_PLACEHOLDER', 'safari', 'LXirr', 'bcdc9ea3-4663-43f1-9c72-59152640b266', 'pl-t-default', 'eqtTi', 'hyunsuk.png', '_bfSendSubTime', 'BX.png', 'EijJN', '#playerSliderArea', 'mask', 'eDNvh', 'KrZed', 'ch_ctr', '#noticeChatWrap', 'UCPDd', 'round', 'createArtistChatDiv', 'canvas', '201026_maybehappyending', 'aYnhV', 'val', '70bebcdc-b7a9-4478-ad60-ac8925042df6', 'clone', 'subtitleList', 'credentials', '210411_boyhood', 'GbKKU', '_showMultiPreview', 'slide-right', 'visibilitychange', 'd59c47cf-bf61-4c4f-b9ca-91667c044279', 'prop', 'rtstr', 'ERROR', 'ticket_id', 'ver_vod', 'fullBtn', 'find', 'QJReK', '#durationWrap', '_logger', '4bb96f7c-3dc1-421b-986f-fc823a081335', 'WdgYk', 'pageX', '.cusDD_select', 'KKyxS', 'durationEnd', 'fontWeight', '_changingView', 'chat_test', 'BMOGI', 'ZLlZk', 'active', 'menuOpenerClass', 'sliderArea', 'currentTime', 'paused', '#lockBtn', '.ta_c > button', 'e48fcdad-a485-4f0d-9ef4-df37b43bb560', 'blur', 'ios', 'xCRuB', '_logItv', 'publish', 'wWLhG', '[JSH]LIVE_SINGLE', 'attrs', 'Live ended', 'ap-northeast-2', 'disableMenuOpeners', 'mss', '|&|', 'checkAdminUser', 'singleview_id', 'PsjLY', 'levelController', 'touches', '.vtt', '9eb6375e-38f8-4a7e-abce-15d3cedef40e', 'beforeValue', 'atUPU', 'b1bc33a2-3f99-428f-8063-33ebe6d01c72', '#chatAnchor', '^\s+', '#subtitlePopup button[name=closebtn]', '#chatList', 'fullScreen', '_canvasTimeStamps', '201227_apink', 'XGldz', 'user_agent', 'uqNDB', '#loadingWrap .pl_loader', 'clearCueData', 'charCodeAt', 'MBLKY', 'viewSeekBarThumbnail', 'initQuality', '210117_gentleman', 'qualitySelectBtn', 'VFgkS', 'OgHRN', 'IhvOw', 'frag', '#mvMainDiv video', '#artistChatList .user_chat:eq(-1)', 'tablet', 'changeElementType', '56762a8f-9162-44bf-aec2-d8349f902ef1', 'manualLevel', '_listener', 'tHToM', 'fragLoadingRetryDelay', 'mousemove', 'loading', 'RiBHa', 'removeListener', '#ccSelect', 'GGwuD', 'div[selected=\'selected\']', 'documentElement', '8a201ab9-fab1-4d61-bdac-bd6bcd78c368', 'setAttribute', 'OoFHm', '201122_ohmygirl', '不能用聊天', '210123_btob4u', 'application/x-mpegURL', 'EupBF', 'responseText'];
(function(a, b) {
    var e = function(f) {
        while (--f) {
            a.push(a.shift());
