            ...
            if (h(aw)) {
                ...
                if (i(aw)) {
                    ...
                    if (aw.length < 2 || aw.length > 12) {
                        ...
                        if (NicknameFilter.hasForbidden(aw)) {
                            switch (egl) {
                                case 'ko':
                            ...
                            if (ChatFilter.checkNickname(aw)) {
                                switch (egl) {
                                    case 'ko':
                                    ...
                                    if (s == 'auth') {
                                        ...
                                        if (s == 'enter') {
                                            ...
                                            switch (egl) {
                                                ...
                                                case 'en':
                                                    aM = 'Notification';
                                                    aL = 'Nickname successfully created.';
                                                    aN = 'OK';
                                                    break;
                                                case 'ja':
                                                case 'jp':
                                            ...
                                            alertPopup(aM, aL, aN, j);
                                        }
                                    }
                                }, function(aL, aM) {
                                    a8 = false;
                                    ac();
                                    var aN = aL && aL.Message == 'nickname duplicated.' || aM == 409;
                                    if (aN) {
                                        switch (egl) {
                                            case 'ko':
